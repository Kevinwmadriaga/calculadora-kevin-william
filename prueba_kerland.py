...
class PruebaKerlandApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Prueba k*ERLAND")
    ...
    def create_widgets(self):
        ...
        # Campo para k
        tk.Label(input_frame, text="k:", font=("Arial", 11), bg="#E3F2FD", fg="#000203").grid(row=0, column=0, sticky="w", padx=10, pady=5)
        tk.Entry(input_frame, textvariable=self.k_var, width=10, font=("Arial", 10), relief="solid", bd=2).grid(row=0, column=1, padx=10, pady=5)

        # Campo para media
        tk.Label(input_frame, text="media:", font=("Arial", 11), bg="#E3F2FD", fg="#000203").grid(row=1, column=0, sticky="w", padx=10, pady=5)
        tk.Entry(input_frame, textvariable=self.media_var, width=10, font=("Arial", 10), relief="solid", bd=2).grid(row=1, column=1, padx=10, pady=5)
    ...
    def mostrar_histograma(self, r_values):
        ...
        ax.set_title("Distribución de Números Normalizados (k*ERLAND)", fontsize=16, color='black', pad=20)
